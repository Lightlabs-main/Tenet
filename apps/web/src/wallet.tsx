...
/** Nav wallet control: connect via any Wallet Standard wallet on devnet. */
        ...
        <div className="wallet-menu">
          {account && wallet ? (
            ...
            <div className="wallet-empty">
              No wallet with <strong>devnet</strong> support was detected. Install{" "}
              ...
              <a href="https://backpack.app" target="_blank" rel="noreferrer">Backpack</a>, then switch it to devnet.
            </div>
          ) : (
            wallets.map((w) => (
