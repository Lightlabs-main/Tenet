...
export type InitiateRedemptionMemberSeeds = {
circle: Address;
memberOwner: Address;
};

export async function findInitiateRedemptionMemberPda(seeds: InitiateRedemptionMemberSeeds, config: { programAddress?: Address | undefined } = {}): Promise<ProgramDerivedAddress> {
